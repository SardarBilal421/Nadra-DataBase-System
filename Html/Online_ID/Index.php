...
<a href="./CNIC_Registeration_Foam.php">

<div class="btn btn-primary my-3 mx-5">
    Apply For CNIC
</div>
</a>
<br><br>
...
<table class="table">
    ...
    include ("./User.php");
    $db = new Database();
    $qry = "select * from userregistrations where user_id='".$_SESSION['user_id']."' ";
...
<div>
    <div class="p-3 mb-2 mx-5">
        ...
        <table class="table">
            <h2 class="text-center">Your CNIC Information</h2>
            <thead>
            <tr>
            ...
            $db = new Database();
            $qry = "select * from cnic_info where user_id='".$_SESSION['user_id']."'";
            $users =$conn->query($qry);
            // $users = $db->Search($qry,User::class);
            ...
            if($users -> num_rows >0) {
                while ($row = $users->fetch_assoc()) {
                    ...
                    echo '<td><a href="Update.php?id='.$row['id'].'" class="btn mx-1" >     
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
                        <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z"/>
                        <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z"/>
                    </svg></a></td>';
                    echo '<td><a href="Delete.php?id='.$row['id'].'" class="btn mx-1" >        
                        ...
                        <form action="" method="post">
                            <div class=" mb-3 mx-5 my-5 align-items-center">
                                <div class="mb-3  mx-5 col-lg-6 col-md-12">
                                    <input type="hidden" class="form-control" id="ForeName"value="<?php echo $ID ?>" name="id" placeholder="id" required>
                                ...
                                <input type="submit" name="Update" value="Update" class="btn btn-primary Register-btn mx-5 my-3" formaction="UserInfoUpdated.php?id='.$ID.'" >
